			...
			<div id="page-wrapper">
				...
				<!-- Wrapper -->
					<section id="wrapper">
						<header>
							<div class="inner">
								<h2>Our real estate</h2>
								<p>Only the best is good enough for you.</p>
							</div>
						</header>
						...
						<!-- Content -->
							<div class="wrapper">
								<div class="inner">
									...
									<h3 class="major">Current offers</h3>
									<p>Here, we have prepared a selection of the lodgings we currently have on offer. Please do not hesitate to contact us even if none of these offers strikes your fancy - we assure you that our experienced team will identify the perfect home for you and will assist you in all necessary formalities in its acquisition.</p>

									<section class="features">
										<article>
											<a href="#" class="image"><img src="images/home1.jpg" alt="" /></a>
											<h3 class="major">Reinickendorf Cottage</h3>
											<p>A small modern cottage in a peaceful side street in Reinickendorf.</p>
											<a href="#" class="special">Learn more</a>
										</article>
										<article>
											<a href="#" class="image"><img src="images/home2.jpg" alt="" /></a>
											<h3 class="major">Alexanderplatz Maisonette</h3>
											<p>A stylish maisonette within walking distance of the very central Alexanderplatz.</p>
											<a href="#" class="special">Learn more</a>
										</article>
										<article>
											<a href="#" class="image"><img src="images/home3.jpg" alt="" /></a>
											<h3 class="major">Mitte Concept</h3>
											<p>Modern concept living in Mitte.</p>
											<a href="#" class="special">Learn more</a>
										</article>
									</section>
